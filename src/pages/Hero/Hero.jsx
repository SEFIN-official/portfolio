...
export default function Hero() {
  const words = heroFlipWords;

  const [code] = useState(heroCodeSnippet);
  ...
  return (
    <>
      <main id="top" className="bg-[#020617] text-white min-h-screen">
        <section
